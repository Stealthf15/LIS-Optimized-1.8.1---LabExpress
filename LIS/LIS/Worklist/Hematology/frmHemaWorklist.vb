...
Public Class frmHemaWorklist
    ...
    Private Sub cboSection_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboLocation1.SelectedIndexChanged, dtTo1.TextChanged, dtFrom1.TextChanged, txtSearch1.TextChanged, btnRefresh.ItemClick
...
#Region "DisplayResults"
    ...
    Private Sub DisplayResult()
        ...
        frmHemaNew.status = GridView.GetFocusedRowCellValue(GridView.Columns("Status")).ToString
        ...
        frmHemaNew.dtReceived.Value = Format(CDate(GridView.GetFocusedRowCellValue(GridView.Columns("DateReceived")).ToString), "MM/dd/yyyy")
        frmHemaNew.tmTimeReceived.Text = Format(CDate(GridView.GetFocusedRowCellValue(GridView.Columns("DateReceived")).ToString), "hh:mm:ss tt")
        ...
        frmHemaNew.cboVerify.Text = GridView.GetFocusedRowCellValue(GridView.Columns("VerifiedBy")).ToString
        ...
        reader.Read()
        If reader.HasRows Then
            frmHemaNew.txtAddress.Text = reader(0).ToString
            frmHemaNew.txtContact.Text = reader(1).ToString
            frmHemaNew.cboCS.Text = reader(2).ToString
        End If
        Disconnect()
        '######################################----END-----###############################################################
        ...
        reader.Read()
        If reader.HasRows Then
            frmHemaNew.txtExtracted.Text = reader(0).ToString
            Disconnect()
        End If
        Disconnect()
        ...
        reader.Read()
        If reader.HasRows Then
            frmHemaNew.txtAccession.Text = reader(0).ToString
            frmHemaNew.txtORNo.Text = reader(1).ToString
            frmHemaNew.txtChargeSlip.Text = reader(2).ToString
        End If
        Disconnect()
        '######################################----END-----###############################################################
        ...
        reader.Read()
        If reader.HasRows Then
            frmHemaNew.txtRemarks.Text = reader(0).ToString
            frmHemaNew.txtComment.Text = reader(1).ToString
        End If
        Disconnect()
        ...
        reader = rs.ExecuteReader
        While reader.Read
            frmHemaNew.cboPathologist.Text = reader(0).ToString
        End While
        Disconnect()
        '######################################----END-----###############################################################
        ...
        'reader = rs.ExecuteReader
        'While reader.Read
        '    frmHemaNew.cboPathologist.Properties.Items.Add(reader(0))
        'End While
        'Disconnect()
        ''######################################----END-----###############################################################
        ...
        'reader = rs.ExecuteReader
        'While reader.Read
        '    frmHemaNew.cboVerify.Properties.Items.Add(reader(0))
        'End While
        'Disconnect()
        ''######################################----END-----###############################################################
        ...
        '    reader = rs.ExecuteReader
        '    While reader.Read
        '        frmHemaNew.cboMedTech.Properties.Items.Add(reader(0))
        '    End While
        '    Disconnect()
        ...
        '    frmHemaNew.cboMedTech.SelectedIndex = 0
        ...
        If GridView.GetFocusedRowCellValue(GridView.Columns("Status")) = "Validated" Then
            frmHemaNew.btnPrint.Enabled = False
            frmHemaNew.btnValidate.Enabled = True
            frmHemaNew.btnPrintNow.Enabled = True
        End If
        '############################----------End------------##############################################################

        'frmHemaNew.GetBDate()

        'frmHemaNew.cboPathologist.SelectedIndex = 0
    ...
    Private Sub DisplayResultCompleted()
        ...
        frmHemaOrdered.dtReceived.Text = Format(CDate(GridCompleted.GetFocusedRowCellValue(GridCompleted.Columns("DateReceived")).ToString), "MM/dd/yyyy")
        frmHemaOrdered.tmTimeReceived.Text = Format(CDate(GridCompleted.GetFocusedRowCellValue(GridCompleted.Columns("DateReceived")).ToString), "hh:mm:ss tt")
        frmHemaOrdered.tmTimeReleased.Text = Format(CDate(GridCompleted.GetFocusedRowCellValue(GridCompleted.Columns("DateReleased")).ToString), "MM/dd/yyyy hh:mm:ss tt")
        ...
        reader.Read()
        If reader.HasRows Then
            frmHemaOrdered.txtAddress.Text = reader(0).ToString
            frmHemaOrdered.txtContact.Text = reader(1).ToString
            frmHemaOrdered.cboCS.Text = reader(2).ToString
        End If
        Disconnect()
        '######################################----END-----###############################################################
        ...
        reader.Read()
        If reader.HasRows Then
            frmHemaOrdered.txtAccession.Text = reader(0).ToString
            frmHemaOrdered.txtORNo.Text = reader(1).ToString
            frmHemaOrdered.txtChargeSlip.Text = reader(2).ToString
        End If
        Disconnect()
        '######################################----END-----###############################################################
        ...
        reader.Read()
        If reader.HasRows Then
            frmHemaOrdered.txtRemarks.Text = reader(0).ToString
            frmHemaOrdered.txtComment.Text = reader(1).ToString
        End If
        Disconnect()
        '######################################----END-----###############################################################
        ...
        reader = rs.ExecuteReader
        While reader.Read
            frmHemaOrdered.cboPathologist.Text = reader(0).ToString
        End While
        Disconnect()
