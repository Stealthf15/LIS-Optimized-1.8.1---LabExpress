Public Class frmChemPatientList
    ...
    Private Sub SimpleButton2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSelect.ItemClick
        ...
        If Me.lvList.SelectedItems.Count > 0 Then
            If Type = "New" Then
                frmChemNew.txtPatientID.Text = lvList.FocusedItem.SubItems(0).Text
                frmChemNew.txtName.Text = lvList.FocusedItem.SubItems(1).Text
                frmChemNew.cboSex.Text = lvList.FocusedItem.SubItems(2).Text
                frmChemNew.dtBDate.Text = lvList.FocusedItem.SubItems(3).Text
                frmChemNew.txtAge.Text = lvList.FocusedItem.SubItems(4).Text
                frmChemNew.txtAddress.Text = lvList.FocusedItem.SubItems(5).Text
                frmChemNew.txtContact.Text = lvList.FocusedItem.SubItems(6).Text
                Me.Close()
                Me.Dispose()
            ElseIf Type = "Old" Then
                frmChemOrdered.txtPatientID.Text = lvList.FocusedItem.SubItems(0).Text
                frmChemOrdered.txtName.Text = lvList.FocusedItem.SubItems(1).Text
                frmChemOrdered.cboSex.Text = lvList.FocusedItem.SubItems(2).Text
                frmChemOrdered.dtBDate.Text = lvList.FocusedItem.SubItems(3).Text
                frmChemOrdered.txtAge.Text = lvList.FocusedItem.SubItems(4).Text
                frmChemOrdered.txtAddress.Text = lvList.FocusedItem.SubItems(5).Text
                frmChemOrdered.txtContact.Text = lvList.FocusedItem.SubItems(6).Text
                Me.Close()
                Me.Dispose()
            End If
        End If
