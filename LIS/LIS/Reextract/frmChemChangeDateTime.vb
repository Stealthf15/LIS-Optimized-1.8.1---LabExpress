...
Public Class frmChemChangeDateTime
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles btnChange.Click
        ...
        Else
            ...
            frmChemNew.txtRemarks.Text = txtReason.Text & vbNewLine & "Changed Extracted Date and Time: " & dtChange.Value

            ActivityLogs(frmChemNew.txtSampleID.Text,
                             frmChemNew.txtPatientID.Text,
                              frmChemNew.txtName.Text,
                             CurrUser,
                             "Changed Chemistry Extraction Date",
    ...
    Private Sub frmChemChangeDateTime_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        Me.Dispose()
    End Sub
End Class