...
Public Class frmUrinAddTest
    ...
    Public Sub LoadRecords()
        Try
            ...
            rs.CommandText = "SELECT * FROM `specimen` WHERE `section` = 'Urinalysis' AND `status` = 'Enable' AND `instrument` = 'Other_Test' ORDER BY `order_no`"
    ...
    Private Sub btnAddTest_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnAddTest.ItemClick
        ...
        ActivityLogs(frmHemaNew.txtSampleID.Text,
                             frmurinNew.txtPatientID.Text,
                             frmurinNew.txtName.Text,
                             CurrUser,
                             "Added Test(s)",
                             frmurinNew.cboRequest.Text,
                             Section,
                             SubSection)
