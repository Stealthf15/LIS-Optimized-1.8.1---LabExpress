...
Public Class frmFecalAddTest
    ...
    Public Sub LoadRecords()
        Try
            ...
            Connect()
            rs.Connection = conn
            rs.CommandText = "SELECT * FROM `default_specimen` WHERE `Section` = 'Fecalysis' AND `status` = 'Enable' ORDER BY `order_no`"
