...
Public Class frmSeroAddTest
    ...
    Public Sub LoadRecords()
        Try
            ...
            Connect()
            rs.Connection = conn
            rs.CommandText = "SELECT * FROM `default_specimen` WHERE `Section` = 'ImmunoSero' AND `status` = 'Enable' ORDER BY `order_no`"
    ...
    Private Sub btnAddTest_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btnAddTest.ItemClick
        ...
        ActivityLogs(frmSeroNew.txtSampleID.Text,
                             frmSeroNew.txtPatientID.Text,
                             frmSeroNew.txtName.Text,
                             CurrUser,
                             "Added Test(s)",
