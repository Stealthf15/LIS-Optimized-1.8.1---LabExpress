...
Partial Class frmFrontDesk
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnAddPatientOrder = New DevExpress.XtraBars.BarLargeButtonItem()
        ...
        Me.btnAddPatient = New DevExpress.XtraBars.BarButtonItem()
        ...
        Me.Bar.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.btnReprint, True), New DevExpress.XtraBars.LinkPersistInfo(Me.btnAdd, True), New DevExpress.XtraBars.LinkPersistInfo(Me.btnAddPatientOrder, True), New DevExpress.XtraBars.LinkPersistInfo(DevExpress.XtraBars.BarLinkUserDefines.PaintStyle, Me.btnEdit, "", True, True, True, 0, Nothing, DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph), New DevExpress.XtraBars.LinkPersistInfo(Me.btnCancel, True), New DevExpress.XtraBars.LinkPersistInfo(Me.btnDelete, True), New DevExpress.XtraBars.LinkPersistInfo(Me.btnRefresh, True), New DevExpress.XtraBars.LinkPersistInfo(Me.btnClose)})
        ...
        Me.btnAdd.DropDownControl = Me.PopupMenu2
        Me.btnAdd.Id = 6
        ...
        'PopupMenu2
        '
        Me.PopupMenu2.Manager = Me.BarManager
        Me.PopupMenu2.Name = "PopupMenu2"
        '
        'btnEdit
        '
        Me.btnEdit.Caption = "Edit Patient Order"
        ...
        'btnAddPatientOrder
        '
        Me.btnAddPatientOrder.Caption = "Add Patient Order"
        Me.btnAddPatientOrder.CaptionAlignment = DevExpress.XtraBars.BarItemCaptionAlignment.Right
        Me.btnAddPatientOrder.Id = 29
        Me.btnAddPatientOrder.ImageOptions.SvgImage = CType(resources.GetObject("btnAddPatientOrder.ImageOptions.SvgImage"), DevExpress.Utils.Svg.SvgImage)
        Me.btnAddPatientOrder.ImageOptions.SvgImageSize = New System.Drawing.Size(24, 24)
        Me.btnAddPatientOrder.Name = "btnAddPatientOrder"
        '
        ...
        'btnAddPatient
        '
        Me.btnAddPatient.ActAsDropDown = True
        Me.btnAddPatient.Caption = "Add Patient Order"
        ...
        Me.picCode.Location = New System.Drawing.Point(154, 285)
    ...
    Friend WithEvents btnAddPatient As DevExpress.XtraBars.BarButtonItem
    ...
    Friend WithEvents btnAddPatientOrder As DevExpress.XtraBars.BarLargeButtonItem
End Class
